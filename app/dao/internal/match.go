...
// MatchColumns defines and stores column names for table match.
type matchColumns struct {
	Id         string //               
    Kvurl      string //               
    Title      string //               
    Index      string //               
    Type       string // 1:场内2:场外  
    CreatedAt  string //               
    UpdatedAt  string //
}
...
func (d *MatchDao) LeftJoin(table ...string) *MatchDao {
	return &MatchDao{M: d.M.LeftJoin(table...)}
}
...
func (d *MatchDao) RightJoin(table ...string) *MatchDao {
	return &MatchDao{M: d.M.RightJoin(table...)}
}
...
func (d *MatchDao) Where(where interface{}, args ...interface{}) *MatchDao {
	return &MatchDao{M: d.M.Where(where, args...)}
}
...
func (d *MatchDao) Limit(limit ...int) *MatchDao {
	return &MatchDao{M: d.M.Limit(limit...)}
}

// Offset sets the "OFFSET" statement for the model.
// It only makes sense for some databases like SQLServer, PostgreSQL, etc.
func (d *MatchDao) Offset(offset int) *MatchDao {
	return &MatchDao{M: d.M.Offset(offset)}
}
...
func (d *MatchDao) Page(page, limit int) *MatchDao {
	return &MatchDao{M: d.M.Page(page, limit)}
}

// Batch sets the batch operation number for the model.
func (d *MatchDao) Batch(batch int) *MatchDao {
	return &MatchDao{M: d.M.Batch(batch)}
}
...
func (d *MatchDao) Cache(duration time.Duration, name ...string) *MatchDao {
	return &MatchDao{M: d.M.Cache(duration, name...)}
}
...
func (d *MatchDao) Data(data ...interface{}) *MatchDao {
	return &MatchDao{M: d.M.Data(data...)}
}

// All does "SELECT FROM ..." statement for the model.
// It retrieves the records from table and returns the result as []*model.Match.
...
// One retrieves one record from table and returns the result as *model.Match.
// It returns nil if there's no record retrieved with the given conditions from table.
//
// The optional parameter <where> is the same as the parameter of M.Where function,
// see M.Where.
...
func (d *MatchDao) LockUpdate() *MatchDao {
	return &MatchDao{M: d.M.LockUpdate()}
}

// LockShared sets the lock in share mode for current operation.
func (d *MatchDao) LockShared() *MatchDao {
	return &MatchDao{M: d.M.LockShared()}
}

// Unscoped enables/disables the soft deleting feature.
func (d *MatchDao) Unscoped() *MatchDao {
	return &MatchDao{M: d.M.Unscoped()}
}