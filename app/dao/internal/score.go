...
func (d *ScoreDao) LeftJoin(table ...string) *ScoreDao {
	return &ScoreDao{M: d.M.LeftJoin(table...)}
}
...
func (d *ScoreDao) RightJoin(table ...string) *ScoreDao {
	return &ScoreDao{M: d.M.RightJoin(table...)}
}
...
func (d *ScoreDao) Where(where interface{}, args ...interface{}) *ScoreDao {
	return &ScoreDao{M: d.M.Where(where, args...)}
}
...
func (d *ScoreDao) Limit(limit ...int) *ScoreDao {
	return &ScoreDao{M: d.M.Limit(limit...)}
}

// Offset sets the "OFFSET" statement for the model.
// It only makes sense for some databases like SQLServer, PostgreSQL, etc.
func (d *ScoreDao) Offset(offset int) *ScoreDao {
	return &ScoreDao{M: d.M.Offset(offset)}
}
...
func (d *ScoreDao) Page(page, limit int) *ScoreDao {
	return &ScoreDao{M: d.M.Page(page, limit)}
}

// Batch sets the batch operation number for the model.
func (d *ScoreDao) Batch(batch int) *ScoreDao {
	return &ScoreDao{M: d.M.Batch(batch)}
}
...
func (d *ScoreDao) Cache(duration time.Duration, name ...string) *ScoreDao {
	return &ScoreDao{M: d.M.Cache(duration, name...)}
}
...
func (d *ScoreDao) Data(data ...interface{}) *ScoreDao {
	return &ScoreDao{M: d.M.Data(data...)}
}

// All does "SELECT FROM ..." statement for the model.
// It retrieves the records from table and returns the result as []*model.Score.
...
// One retrieves one record from table and returns the result as *model.Score.
// It returns nil if there's no record retrieved with the given conditions from table.
//
// The optional parameter <where> is the same as the parameter of M.Where function,
// see M.Where.
...
func (d *ScoreDao) LockUpdate() *ScoreDao {
	return &ScoreDao{M: d.M.LockUpdate()}
}

// LockShared sets the lock in share mode for current operation.
func (d *ScoreDao) LockShared() *ScoreDao {
	return &ScoreDao{M: d.M.LockShared()}
}

// Unscoped enables/disables the soft deleting feature.
func (d *ScoreDao) Unscoped() *ScoreDao {
	return &ScoreDao{M: d.M.Unscoped()}
}