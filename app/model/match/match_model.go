...
// arModel is a active record design model for table match operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of match.
	Table = "match"
	// Model is the model object of match.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table match.
	Columns = struct {
		Id         string //               
        Kvurl      string //               
        Title      string //               
