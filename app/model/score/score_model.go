...
// arModel is a active record design model for table score operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of score.
	Table = "score"
	// Model is the model object of score.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table score.
	Columns = struct {
		Id            string //   
        ContestantId  string //   
        MatchId       string //   
