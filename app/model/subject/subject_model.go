...
// arModel is a active record design model for table subject operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of subject.
	Table = "subject"
	// Model is the model object of subject.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table subject.
	Columns = struct {
		Id         string //   
        Name       string //   
        MatchId    string //   
