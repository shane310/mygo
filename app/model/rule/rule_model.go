...
// arModel is a active record design model for table rule operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rule.
	Table = "rule"
	// Model is the model object of rule.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table rule.
	Columns = struct {
		Id         string //             
        Title      string //             
        Score      string //             
