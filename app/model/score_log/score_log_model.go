...
// arModel is a active record design model for table score_log operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of score_log.
	Table = "score_log"
	// Model is the model object of score_log.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table score_log.
	Columns = struct {
		Id            string //   
        ContestantId  string //   
        MatchId       string //   
