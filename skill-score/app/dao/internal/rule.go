...
func (d *RuleDao) LeftJoin(table ...string) *RuleDao {
	return &RuleDao{M: d.M.LeftJoin(table...)}
}
...
func (d *RuleDao) RightJoin(table ...string) *RuleDao {
	return &RuleDao{M: d.M.RightJoin(table...)}
}
...
func (d *RuleDao) Where(where interface{}, args ...interface{}) *RuleDao {
	return &RuleDao{M: d.M.Where(where, args...)}
}
...
func (d *RuleDao) Limit(limit ...int) *RuleDao {
	return &RuleDao{M: d.M.Limit(limit...)}
}

// Offset sets the "OFFSET" statement for the model.
// It only makes sense for some databases like SQLServer, PostgreSQL, etc.
func (d *RuleDao) Offset(offset int) *RuleDao {
	return &RuleDao{M: d.M.Offset(offset)}
}
...
func (d *RuleDao) Page(page, limit int) *RuleDao {
	return &RuleDao{M: d.M.Page(page, limit)}
}

// Batch sets the batch operation number for the model.
func (d *RuleDao) Batch(batch int) *RuleDao {
	return &RuleDao{M: d.M.Batch(batch)}
}
...
func (d *RuleDao) Cache(duration time.Duration, name ...string) *RuleDao {
	return &RuleDao{M: d.M.Cache(duration, name...)}
}
...
func (d *RuleDao) Data(data ...interface{}) *RuleDao {
	return &RuleDao{M: d.M.Data(data...)}
}

// All does "SELECT FROM ..." statement for the model.
// It retrieves the records from table and returns the result as []*model.Rule.
...
// One retrieves one record from table and returns the result as *model.Rule.
// It returns nil if there's no record retrieved with the given conditions from table.
//
// The optional parameter <where> is the same as the parameter of M.Where function,
// see M.Where.
...
func (d *RuleDao) LockUpdate() *RuleDao {
	return &RuleDao{M: d.M.LockUpdate()}
}

// LockShared sets the lock in share mode for current operation.
func (d *RuleDao) LockShared() *RuleDao {
	return &RuleDao{M: d.M.LockShared()}
}

// Unscoped enables/disables the soft deleting feature.
func (d *RuleDao) Unscoped() *RuleDao {
	return &RuleDao{M: d.M.Unscoped()}
}